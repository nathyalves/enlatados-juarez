...
<body>
  <form action="primeiroAcessoController.php" method="post" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin w3-display-middle" style="width: 30%;">
    ...
    <div class="w3-row w3-section">
      <button name="btnCadastrar" class="w3-button w3-block w3-blue w3-round-large">Cadastrar</button>
    </div>
  </form>
</body>
</html>